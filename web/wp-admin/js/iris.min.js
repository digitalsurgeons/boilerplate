        ...
        (n = {
          ...
          _addPalettes: function() {
            var b = a('<div class="iris-palette-container" />'),
              ...
              d = a.isArray(this.options.palettes)
            ...
            switch (((g.options[b] = c), b)) {
              ...
              case 'palettes':
                ;(i = !0),
                  c
                    ? g._addPalettes()
                    : g.picker.find('.iris-palette-container').remove(),
              ...
              case 'border':
                ;(i = !0),
                  (f = c ? 'addClass' : 'removeClass'),
                  g.picker[f]('iris-border')
                break
              case 'mode':
              case 'controls':
                if (h === c) return
    ...
    c.fn = c.prototype = {
      ...
      getReadableContrastingColor: function(a, d) {
        ...
        if (
          ...
          (f = e.getDistanceLuminosityFrom(a)),
          f <= h)
        )
          return e
        for (
