      ...
      _.extend(wp.Backbone.Subviews.prototype, {
          ...
          return (
            ...
            d &&
              (c.add
                ? _.isUndefined(c.at)
                  ? (e = d.concat(b))
                  : ((e = d), e.splice.apply(e, [c.at, 0].concat(b)))
                : (_.each(e, function(a) {
                    a.__detach = !0
                  }),
                  _.each(d, function(a) {
            ...
            c.silent ||
              this._attach(a, b, _.extend({ ready: this._isReady() }, c)),
            this
          )
        },
        add: function(a, b, c) {
        ...
        insert: function(a, b, c) {
          var d,
            e = c && c.at
          return (
            _.isNumber(e) && (d = a.children()).length > e
              ? d.eq(e).before(b)
              : a.append(b),
            this
          )
