...
if (typeof jQuery != 'undefined') {
  ...
  jQuery(document).ready(function($) {
    ...
    refresh = function(i, el) {
      // force the browser to refresh the tabbing index
      var node = $(el),
  ...
  ;(function(d, w) {
    var addEvent = function(obj, type, fn) {
      ...
      scrollToTop = function(t) {
        ...
        if (t.id != 'wpadminbar' && t.id != 'wp-admin-bar-top-secondary') return
        ...
        step =
          distance > 800 ? Math.round(distance / 30) : Math.round(distance / 20)
        steps = []
        timer = 0
