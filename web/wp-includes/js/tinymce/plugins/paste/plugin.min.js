  ...
  function M(n, r, a, i) {
    ...
    return (
      ...
      /(bold)/i.test(s['font-weight']) &&
        (delete s['font-weight'], a.wrap(new T('b', 1))),
      /(italic)/i.test(s['font-style']) &&
        (delete s['font-style'], a.wrap(new T('i', 1))),
  ...
  var S = {
      preProcess: function(e, t) {
        return m.shouldUseDefaultFilters(e)
          ? (function(r, e) {
              ...
              var s = o.parse(e)
              return (
                m.shouldConvertWordFakeLists(r) && E(s),
                (e = C({ validate: r.settings.validate }, i).serialize(s))
              )
            })(e, t)
          : t
      },
    ...
    U = function(e, t, n, r) {
      ...
      var i,
        ...
        p =
          e.settings.images_reuse_filename && r.name
            ? ((s = e),
              (l = r.name),
              (u = l.match(/([\s\S]+?)\.(?:jpeg|jpg|png|gif)$/i))
                ? s.dom.encode(u[1])
                : null)
            : g,
        v = new Image()
      if (
        ...
        (c = e.settings),
        (f = v),
        !c.images_dataimg_filter || c.images_dataimg_filter(f))
      ) {
        var h,
        ...
        if (e)
          for (t = 0; t < e.length; t++)
            if (((n = e[t]), /^image\/(jpeg|png|gif|bmp)$/.test(n.type))) {
              ...
              ;((r = new window.FileReader()).onload = U.bind(
                null,
                o,
                l,
                r,
      ...
      return {
        create: function() {
          return (function(e, t, n) {
            ...
            if (
              (e.inline &&
                (a = e.selection.getScrollContainer()) &&
                0 < a.scrollTop &&
                (s = a.scrollTop),
              u.getClientRects)
            ) {
              var c = (function(e) {
                ...
                if (e.collapsed && 1 === a.nodeType) {
                  for (
                    r = a.childNodes[u.startOffset];
                    r && 3 === r.nodeType && !r.data.length;
        ...
        isDefault: function() {
          return (
            (e = a),
            (n = Y(r)),
            (t = n) && 'mcepastebin' === t.id && Z(e, n.innerHTML)
          )
          var e, t, n
        },
    ...
    ne = function(e, t, n, r) {
      te(e.clipboardData, t.html, t.text)
        ? (e.preventDefault(), r())
        : n(t.html, r)
    },
    re = function(s) {
