;(function() {
  var image = (function() {
    ...
    var waitLoadImage = function(editor, data, imgElm) {
      ...
      imgElm.onload = function() {
        if (
          !data.width &&
          !data.height &&
          $_9cq6y3c6jfuw8p0n.hasDimensions(editor)
        ) {
    ...
    var deep = function(old, nu) {
      var bothObjects =
        $_rbqovckjfuw8p27.isObject(old) && $_rbqovckjfuw8p27.isObject(nu)
    ...
    var create = function(normalizeCss, data) {
      ...
      write(
        normalizeCss,
        $_ajpvnqcjjfuw8p25.merge(data, { caption: false }),
        image
      )
      ...
      return function(evt) {
        ...
        if (
          ...
          if (css['margin-top'] === css['margin-bottom']) {
            rootControl
              .find('#vspace')
              .value($_7v7yldc7jfuw8p0q.removePixelSuffix(css['margin-top']))
          } else {
            rootControl.find('#vspace').value('')
          }
          if (css['margin-right'] === css['margin-left']) {
            rootControl
              .find('#hspace')
              .value($_7v7yldc7jfuw8p0q.removePixelSuffix(css['margin-right']))
          } else {
            rootControl.find('#hspace').value('')
          }
        }
        if (css['border-width']) {
          rootControl
            .find('#border')
            .value($_7v7yldc7jfuw8p0q.removePixelSuffix(css['border-width']))
        } else {
    ...
    var onSrcChange = function(evt, editor) {
      ...
      if (!meta.width && !meta.height) {
        ...
        $_7v7yldc7jfuw8p0q.getImageSize(
    ...
    var getGeneralItems = function(editor, imageListCtrl) {
      ...
      if ($_9cq6y3c6jfuw8p0n.getClassList(editor)) {
        generalFormItems.push({
          ...
          type: 'listbox',
          label: 'Class',
          values: $_7v7yldc7jfuw8p0q.buildListItems(
            $_9cq6y3c6jfuw8p0n.getClassList(editor),
            function(item) {
              if (item.value) {
    ...
    var submitForm = function(editor, evt) {
      ...
      editor.undoManager.transact(function() {
        var data = $_ajpvnqcjjfuw8p25.merge(
    ...
    function Dialog(editor) {
      function showDialog(imageList) {
        ...
        if (
          $_9cq6y3c6jfuw8p0n.hasAdvTab(editor) ||
          $_9cq6y3c6jfuw8p0n.hasUploadUrl(editor) ||
          $_9cq6y3c6jfuw8p0n.hasUploadHandler(editor)
        ) {
