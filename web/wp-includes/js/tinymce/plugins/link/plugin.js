;(function() {
  var link = (function() {
    ...
    var link = function(editor, attachState) {
      return function(data) {
        editor.undoManager.transact(function() {
          ...
          if (
            !$_ae1yh4f3jfuw8pj4.hasRelList(editor.settings) &&
            $_ae1yh4f3jfuw8pj4.allowUnsafeLinkTarget(editor.settings) === false
          ) {
    ...
    var showDialog = function(editor, linkList) {
      ...
      data.text = initialText = $_fs5xf5f7jfuw8pjf.getAnchorText(
        editor.selection,
        anchorElm
      )
      ...
      if ($_ae1yh4f3jfuw8pj4.shouldShowTargetList(editor.settings)) {
        ...
        targetListCtrl = {
          ...
          label: 'Target',
          values: buildListItems(
            $_ae1yh4f3jfuw8pj4.getTargetList(editor.settings)
          )
        }
      }
      if ($_ae1yh4f3jfuw8pj4.hasRelList(editor.settings)) {
        relListCtrl = {
          ...
          label: 'Rel',
          values: buildListItems(
            $_ae1yh4f3jfuw8pj4.getRelList(editor.settings),
            function(item) {
              if (
                $_ae1yh4f3jfuw8pj4.allowUnsafeLinkTarget(editor.settings) ===
                false
              ) {
                item.value = $_fs5xf5f7jfuw8pjf.toggleTargetRules(
                  item.value,
                  data.target === '_blank'
                )
              }
      ...
      if ($_ae1yh4f3jfuw8pj4.hasLinkClassList(editor.settings)) {
        classListCtrl = {
          ...
          label: 'Class',
          values: buildListItems(
            $_ae1yh4f3jfuw8pj4.getLinkClassList(editor.settings),
            function(item) {
              if (item.value) {
      ...
      win = editor.windowManager.open({
        ...
        onSubmit: function(e) {
          var assumeExternalTargets = $_ae1yh4f3jfuw8pj4.assumeExternalTargets(
            editor.settings
          )
    ...
    var leftClickedOnAHref = function(editor) {
      return function(elm) {
        var sel, rng, node
        if (
          $_ae1yh4f3jfuw8pj4.hasContextToolbar(editor.settings) &&
          !isContextMenuVisible(editor) &&
          $_fs5xf5f7jfuw8pjf.isLink(elm)
        ) {
    ...
    var toggleActiveState = function(editor) {
      return function() {
        ...
        editor.on('nodechange', function(e) {
          self.active(
            !editor.readonly &&
              !!$_fs5xf5f7jfuw8pjf.getAnchorElement(editor, e.element)
          )
        })
      }
    }
    ...
    var setupContextToolbars = function(editor) {
      if (editor.addContextToolbar) {
        editor.addContextToolbar(
          $_auu7ckf1jfuw8pj0.leftClickedOnAHref(editor),
