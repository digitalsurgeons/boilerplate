;(function($) {
  ...
  $(document).on('click', '.repeater .repeater-footer .add-row-end', function(
    e
  ) {
    e.preventDefault()
  ...
  $(document).on('click', '.repeater td.remove .add-row-before', function(e) {
    ...
    acf.fields.repeater
      .set({ $el: $(this).closest('.repeater') })
      .add($(this).closest('tr'))

    $(this).blur()
  })

  $(document).on('click', '.repeater td.remove .acf-button-remove', function(
    e
  ) {
    e.preventDefault()
  ...
  $(document).on(
    'acf/conditional_logic/show acf/conditional_logic/hide',
    function(e, $target, item) {
