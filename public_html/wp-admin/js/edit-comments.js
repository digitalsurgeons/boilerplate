...
;(function($) {
  ...
  updateDashboardText = function(response) {
    ...
    $('.comment-mod-count a', rightNow)
      .text(response.i18n_moderation_text)
      .parent()
  ...
  setCommentsList = function() {
    ...
    theExtraList = $('#the-extra-comment-list').wpList({
      alt: '',
      delColor: 'none',
      addColor: 'none'
    })
    theList = $('#the-comment-list')
      .wpList({
        alt: '',
        delBefore: delBefore,
        dimAfter: dimAfter,
  ...
  commentReply = {
    ...
    close: function() {
      ...
      if (replyrow.parent().is('#com-reply')) return
