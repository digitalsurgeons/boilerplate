...
function uploadError(fileObj, errorCode, message, uploader) {
  ...
  switch (errorCode) {
    ...
    case plupload.IO_ERROR:
      ...
      else wpQueueError(pluploadL10n.io_error)
      break
...
jQuery(document).ready(function($) {
  ...
  uploader_init = function() {
    ...
    if (
      !isIE &&
      'flash' === plupload.predictRuntime(wpUploaderInit) &&
      (!wpUploaderInit.required_features ||
        !wpUploaderInit.required_features.hasOwnProperty('send_binary_string'))
    ) {
