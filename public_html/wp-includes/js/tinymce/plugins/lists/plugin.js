;(function() {
  var lists = (function() {
    ...
    var getNormalizedEndPoint = function(container, offset) {
      ...
      if (
        $_fmlqy7fsjfuw8plr.isListItemNode(container) &&
        $_fmlqy7fsjfuw8plr.isTextNode(node)
      ) {
        var textNodeOffset =
    ...
    var createNewTextBlock = function(editor, contentNode, blockName) {
      ...
      if (blockName) {
        ...
        if (
          !$_fmlqy7fsjfuw8plr.isBlock(contentNode.firstChild, blockElements)
        ) {
    ...
    var outdent = function(editor, li) {
      ...
      if (
        $_fmlqy7fsjfuw8plr.isFirstChild(li) &&
        $_fmlqy7fsjfuw8plr.isLastChild(li)
      ) {
        if (ulParent.nodeName === 'LI') {
          ...
          ulParent.insertBefore(
            $_3c0i4zfxjfuw8pm1.createNewTextBlock(editor, li),
            ul
          )
          DOM$4.remove(ul)
        }
    ...
    var outdentSelection = function(editor) {
      ...
      if (listElements.length) {
        var bookmark = $_3byghwfqjfuw8pln.createBookmark(
          editor.selection.getRng()
        )
        var i = void 0,
          y = void 0
        var root = $_2bncsnfujfuw8plw.getClosestListRootElm(
          editor,
    ...
    var getSelectedTextBlocks = function(editor, rng, root) {
      ...
      global$5.each(siblings, function(node) {
        ...
        if (global$4.isBookmarkNode(node)) {
          if (
            $_fmlqy7fsjfuw8plr.isTextBlock(editor, nextSibling) ||
    ...
    var applyList = function(editor, listName, detail) {
      ...
      global$5.each(getSelectedTextBlocks(editor, rng, root), function(block) {
        ...
        if (
          sibling &&
          $_fmlqy7fsjfuw8plr.isListNode(sibling) &&
    ...
    var isValidLists = function(list1, list2) {
      return (
        list1 &&
        list2 &&
        $_fmlqy7fsjfuw8plr.isListNode(list1) &&
    ...
    var hasOnlyOneBlockChild = function(dom, elm) {
      ...
      return (
        childNodes.length === 1 &&
        !$_fmlqy7fsjfuw8plr.isListNode(childNodes[0]) &&
    ...
    var mergeLiElements = function(dom, fromElm, toElm) {
      ...
      if (
        !$_fmlqy7fsjfuw8plr.isChildOfBody(dom, fromElm) ||
        !$_fmlqy7fsjfuw8plr.isChildOfBody(dom, toElm)
      ) {
        return
      }
    ...
    var backspaceDeleteIntoListCaret = function(editor, isForward) {
      ...
      if (block && dom.isEmpty(block)) {
        var rng = $_14fh94frjfuw8plp.normalizeRange(
          editor.selection.getRng(true)
        )
    ...
    var backspaceDeleteRange = function(editor) {
      ...
      if (
        startListParent ||
        $_2bncsnfujfuw8plw.getSelectedListItems(editor).length > 0
      ) {
        editor.undoManager.transact(function() {
    ...
    var indent = function(li) {
      ...
      if (
        sibling &&
        sibling.nodeName === 'LI' &&
        $_fmlqy7fsjfuw8plr.isListNode(sibling.lastChild)
      ) {
      ...
      return function(e) {
        ...
        editor.on('NodeChange', function(e) {
          var tableCellIndex = findIndex(
            e.parents,
            $_fmlqy7fsjfuw8plr.isTableCellNode
          )
          var parents =
            tableCellIndex !== -1
      ...
      return function(e) {
        ...
        editor.on('nodechange', function() {
          ...
          var disable =
            ...
            $_fmlqy7fsjfuw8plr.isFirstChild(listItemBlocks[0])
