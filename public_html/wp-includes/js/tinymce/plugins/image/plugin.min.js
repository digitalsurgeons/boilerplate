!(function() {
  ...
  var e = tinymce.util.Tools.resolve('tinymce.PluginManager'),
    ...
    r = function(e, t) {
      for (
        var n = t !== undefined && null !== t ? t : a, r = 0;
  ...
  var n = tinymce.util.Tools.resolve('tinymce.util.Promise'),
    ...
    I = function(e) {
      ...
      T(e)
        ...
        : ((t = e),
          ...
          n.appendChild(t),
          n.appendChild(
            y.create('figcaption', { contentEditable: !0 }, 'Caption')
          ),
    ...
    J = function(t, e) {
      var n = (function(e, t) {
        var n = document.createElement('img')
        if (
          (j(e, b.merge(t, { caption: !1 }), n), P(n, 'alt', t.alt), t.caption)
        ) {
          ...
          items: [
            {
              ...
              function(e) {
                ...
                if (d.hasAdvTab(i)) {
                  ...
                  n.find('#vspace').value(''),
                    n.find('#hspace').value(''),
                    (((a = g.mergeMargins(a))['margin-top'] &&
                      a['margin-bottom']) ||
                      (a['margin-right'] && a['margin-left'])) &&
                      (a['margin-top'] === a['margin-bottom']
                        ? n
                            .find('#vspace')
                            .value(g.removePixelSuffix(a['margin-top']))
                        : n.find('#vspace').value(''),
                      a['margin-right'] === a['margin-left']
                        ? n
                            .find('#hspace')
                            .value(g.removePixelSuffix(a['margin-right']))
                        : n.find('#hspace').value('')),
                    a['border-width']
                      ? n
                          .find('#border')
                          .value(g.removePixelSuffix(a['border-width']))
                      : n.find('#border').value(''),
                    a['border-style']
    ...
    te = function(c, e) {
      var t = [
        {
          ...
          onchange: function(e) {
            ...
            ;(n = c),
              ...
              (l = t.control),
              (u = l.rootControl),
              (s = u.find('#image-list')[0]) &&
                s.value(n.convertURL(l.value(), 'src')),
      ...
      return (
        ...
        d.hasImageCaption(c) &&
          t.push({ name: 'caption', type: 'checkbox', label: 'Caption' }),
        t
      )
    },
    ne = {
      ...
      return function(e) {
        for (
          ...
          (t = e[r]),
            (n = t.attr('class')) &&
              /\bimage\b/.test(n) &&
              (t.attr('contenteditable', i ? 'false' : null),
              f.each(t.getAll('figcaption'), a))
      }
    },
    xe = function(e) {
      e.on('preInit', function() {
        e.parser.addNodeFilter('figure', ye(!0)),
          e.serializer.addNodeFilter('figure', ye(!1))
      })
    },
    we = function(e) {
      e.addButton('image', {
