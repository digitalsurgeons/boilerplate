  ...
  var paste = (function() {
    ...
    var shouldInformUserAboutPlainText = function(editor, userIsInformedState) {
      return (
        ...
        $_dls6llhqjfuw8ptf.shouldPlainTextInform(editor)
      )
    }
    ...
    var register = function(editor, clipboard, userIsInformedState) {
      editor.addCommand('mceTogglePlainTextPaste', function() {
        $_btm9r2hojfuw8ptc.togglePlainTextPaste(
          editor,
          clipboard,
          userIsInformedState
        )
    ...
    function filterStyles(editor, validStyles, node, styleValue) {
      ...
      global$3.each(styles, function(value, name) {
        ...
        if (
          $_dls6llhqjfuw8ptf.getRetainStyleProps(editor) === 'all' ||
    ...
    var preProcess = function(editor, content) {
      return $_dls6llhqjfuw8ptf.shouldUseDefaultFilters(editor)
    ...
    var postProcessFilter = function(editor, html, internal, isWordHtml) {
      ...
      var postProcessArgs = $_ae0f8dhpjfuw8pte.firePastePostProcess(
        editor,
        tempBody,
        internal,
        isWordHtml
    ...
    var filterContent = function(editor, content, internal, isWordHtml) {
      var preProcessArgs = $_ae0f8dhpjfuw8pte.firePastePreProcess(
        editor,
        content,
        internal,
        isWordHtml
    ...
    var process = function(editor, html, internal) {
      ...
      var content = isWordHtml
        ? $_8q8fy4i1jfuw8pu5.preProcess(editor, html)
        : html
    ...
    var pasteHtml$1 = function(editor, html, internalFlag) {
      var internal = internalFlag
        ? internalFlag
        : $_ceqsrthxjfuw8ptx.isMarked(html)
      var args = $_g5r539i0jfuw8pu1.process(
        editor,
        $_ceqsrthxjfuw8ptx.unmark(html),
        internal
      )
    ...
    var pasteText = function(editor, text) {
      ...
      text = $_7lc4hihyjfuw8pty.convert(
        text,
    ...
    var getClipboardContent = function(editor, clipboardEvent) {
      ...
      return $_cedk7ri6jfuw8pud.isMsEdge()
    ...
    var registerEventHandlers = function(editor, pasteBin, pasteFormat) {
      ...
      function insertClipboardContent(
        ...
        pasteBin.remove()
        isPlainTextHtml =
          internal === false && $_7lc4hihyjfuw8pty.isPlainText(content)
      ...
      editor.on('paste', function(e) {
        ...
        var internal = hasContentType(
          clipboardContent,
          $_ceqsrthxjfuw8ptx.internalHtmlMime()
        )
        ...
        if (hasContentType(clipboardContent, 'text/html')) {
          e.preventDefault()
          if (!internal) {
            internal = $_ceqsrthxjfuw8ptx.isMarked(
    ...
    var getHtml = function(editor) {
      ...
      pasteBinClones = global$3.grep(editor.getBody().childNodes, function(
        elm
      ) {
    ...
    var hasWorkingClipboardApi = function(clipboardData) {
      return (
        ...
        $_cedk7ri6jfuw8pud.isMsEdge() !== true
      )
    }
    ...
    var setup = function(editor, clipboard, draggingInternallyState) {
      ...
      editor.on('dragover dragend', function(e) {
        if (
          $_dls6llhqjfuw8ptf.shouldPasteDataImages(editor) &&
    ...
    function removeWebKitStyles(editor, content, internal, isWordHtml) {
      ...
      var webKitStyles
      if (
        $_dls6llhqjfuw8ptf.shouldRemoveWebKitStyles(editor) === false ||
    ...
    global.add('paste', function(editor) {
      if ($_5e30n7hljfuw8pt8.hasProPlugin(editor) === false) {
        ...
        var pasteFormat = Cell(
          $_dls6llhqjfuw8ptf.isPasteAsTextEnabled(editor) ? 'text' : 'html'
        )
