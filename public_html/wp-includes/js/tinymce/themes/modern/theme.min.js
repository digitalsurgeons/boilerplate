!(function() {
  ...
  var e,
    ...
    ve = function(e) {
      return (
        !((me.ie && !(11 <= me.ie)) || !e.sidebars) && 0 < e.sidebars.length
      )
    },
    be = function(n) {
      return {
    ...
    _e = function(t, e, n) {
      ...
      if (
        (!1 === m(t) && n.skinUiCss
          ? xe.styleSheetLoader.load(n.skinUiCss, ye(t))
          : ye(t)(),
        (i = e.panel = v.create({
          type: 'panel',
          role: 'application',
          ...
          items: [
            {
              ...
              items: [
                !1 === d(t)
                  ? null
                  : { type: 'menubar', border: '0 0 1 0', items: le(t) },
                B(t, f(t))
              ]
            },
            ve(t)
        ...
        'none' !== g(t) &&
          (r = {
            ...
            onResize: function(e) {
              'both' === g(t)
                ? fe(t, o.width + e.deltaX, o.height + e.deltaY)
                : fe(t, null, o.height + e.deltaY)
            }
          }),
      ...
      init: function(e) {
        ...
        function a(e, t) {
          ...
          do {
            if (
              (Ue.exec(''),
              (i = Ue.exec(e)) && ((e = i[3]), o.push(i[1]), i[2]))
            ) {
              n = i[3]
              break
            }
      ...
      find: function(e) {
        ...
        function c(e, t, n) {
          ...
          for (i = 0, r = e.length; i < r; i++) {
            ...
            if (o === s)
              n === t.length - 1 ? u.push(a) : a.items && c(a.items(), t, n + 1)
  ...
  var Ke,
          ...
          et[t._id] || (et[t._id] = t),
            Ke ||
              ...
              u.requestAnimationFrame(function() {
                var e, t
                for (e in ((Ke = !1), et))
                  (t = et[e]).state.get('rendered') && t.reflow()
                et = {}
              }, document.body))
        }
      },
    ...
    ot = {
      ...
      getEl: function(e) {
        ...
        return (
          this._elmCache[t] || (this._elmCache[t] = Re('#' + t)[0]),
          this._elmCache[t]
        )
      },
      show: function() {
      ...
      renderTo: function(e) {
        return (
          Re(e || this.getContainerElm()).append(this.renderHtml()),
          this.postRender(),
          this
        )
      },
    ...
    ft = lt.extend({
      ...
      reflow: function() {
        ...
        if ((tt.remove(this), this.visible())) {
          for (
            lt.repaintControls = [],
              lt.repaintControls.map = {},
              this.recalc(),
              e = lt.repaintControls.length;
            e--;
          ...
          function t(e, t, n, i, r, o) {
            ...
            if ((a = p.getEl('scroll' + e))) {
              if (
                ((f = t.toLowerCase()),
                (h = n.toLowerCase()),
                Re(p.getEl('absend')).css(f, p.layoutRect()[i] - 1),
                !r)
              )
  ...
  function Et(r) {
    ...
    function t(e, t) {
      for (var n, i = 0; i < _t.length; i++)
        if (_t[i] !== r)
          for (n = _t[i].parent(); n && (n = n.parent()); )
            n === r &&
              _t[i]
                .fixed(e)
                .moveBy(0, t)
  ...
  function Ht(e, t) {
    ...
    if (Rt.length)
      for (n = 0; n < Rt.length; n++)
        Rt[n].modal && (r++, (i = Rt[n])),
          (Rt[n].getEl().style.zIndex = r),
          (Rt[n].zIndex = r),
          r++
    var o = Re('#' + t.classPrefix + 'modal-block', t.getContainerElm())[0]
    i
      ? Re(o).css('z-index', i.zIndex - 1)
      : o && (o.parentNode.removeChild(o), (bt = !1)),
      (St.currentZIndex = r)
  }
  var St = xt.extend({
    Mixins: [Pe, wt],
  ...
  var Tt = function(e, t) {
    ...
    Pt = function(s, e, t) {
          ...
          a
            ...
            : ((a = e.panel = v.create({
                ...
                items: [
                  !1 === d(s)
                    ? null
                    : { type: 'menubar', border: '0 0 1 0', items: le(s) },
                  B(s, f(s))
                ]
              })),
      ...
      return (
        ...
        !1 === m(s) && t.skinUiCss
          ? l.styleSheetLoader.load(t.skinUiCss, ye(s))
          : ye(s)(),
        {}
      )
    }
  ...
  function jt(e, t) {
    ;(function() {
      ...
      !1 === t &&
      Re([document.documentElement, document.body]).removeClass(
        e + 'fullscreen'
      )
  }
  var qt = St.extend({
    ...
    init: function(e) {
      ...
      n._super(e),
        ...
        n.on('click', function(e) {
          ...
          ;(ke.hasClass(e.target, t) || ke.hasClass(e.target.parentNode, t)) &&
            n.close()
        }),
  ...
  !(function() {
    if (!me.desktop) {
      ...
      u.setInterval(function() {
        ...
        ;(n.w === e && n.h === t) ||
          ((n = { w: e, h: t }), Re(window).trigger('resize'))
      }, 100)
    }
    Re(window).on('resize', function() {
      var e,
  ...
  var Yt,
    ...
    Zt = Kt.extend({
      ...
      remove: function() {
        Re(this.getEl('button')).off(),
          Re(this.getEl('input')).off(),
          this._super()
      }
    }),
    Qt = ft.extend({
    ...
    nn = Bt.extend({
      ...
      repaint: function() {
        ...
        n.statusLevel() &&
          'none' !== n.statusLevel() &&
          (s =
            parseInt(ke.getRuntimeStyle(a, 'padding-right'), 10) -
            parseInt(ke.getRuntimeStyle(a, 'padding-left'), 10)),
    ...
    ci = function(e) {
      return (
        (e.nodeType !== li && e.nodeType !== ui) || 0 === e.childElementCount
      )
    },
    di = {
      all: function(e, t) {
    ...
    Ri = function(e) {
      ...
      return vi(
        ...
        bi(e),
        '#' + i,
        xi((n = e)) ? parseInt(n.nodeName.substr(1), 10) : 0,
        function() {
          e.id = i
        }
      )
    ...
    Hi = function(e) {
      var t,
        ...
        i = ki(e)
      return ie.filter(
        ((n = i), ie.map(ie.filter(n, _i), Ri)).concat(
          ((t = i), ie.map(ie.filter(t, yi), Ci))
        ),
        Ei
      )
    },
        ...
        r.on('PostRender', function() {
          r.getRoot().on('submit', function(e) {
            ...
            e.isDefaultPrevented() ||
              ...
              /^https?/.test(t) &&
                (i
                  ? ie.indexOf(i, t).isNone() &&
                    (Si[n] = i.slice(0, 5).concat(t))
                  : (Si[n] = [t])))
          })
        })
    },
      ...
      return function() {
        ...
        a.on('init nodeChange', function(e) {
          var t,
            ...
            w.each(t, function(e) {
              i ||
                ji(e.value).toLowerCase() !== ji(n).toLowerCase() ||
                (i = e.value)
            }),
            i)
    ...
    Qi = function(n, e) {
      ...
      return (
        e.items().each(function(e) {
          e.menu && e.visible(0 < Qi(n, e.menu)),
            !e.menu && e.settings.menu && e.visible(0 < Zi(n, e.settings.menu))
      ...
      setup: function(e) {
        ...
        e.rtl && (lt.rtl = !0),
          ...
          (t = e).settings.ui_container &&
            (me.container = Ii(
              yn.fromDom(document.body),
              t.settings.ui_container
            ).fold(k.constant(null), function(e) {
              return e.dom()
            })),
          (Bt.tooltips = !me.iOS),
    ...
    wr = St.extend({
      ...
      init: function(e) {
        ...
        this._super(e),
          ...
          e.animate && 11 !== me.ie && this.classes.add('animate')
      },
      repaint: function() {
        return (
  ...
  function Tr(e, t) {
    ...
    'v' === e.settings.orientation
      ...
      (s = e.getEl('handle')),
      (o =
        ((e.layoutRect()[n] || 100) - ke.getSize(s)[i]) *
