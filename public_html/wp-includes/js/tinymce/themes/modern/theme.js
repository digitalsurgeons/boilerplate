;(function() {
  var modern = (function() {
    ...
    var from$1 = $_e8diihtbjfuw8scy.isFunction(Array.from)
      ? Array.from
      : function(x) {
          return slice.call(x)
        }
    ...
    var hasItemName = function(namedMenuItems, name) {
      return $_anxm1mtajfuw8sct
        .findIndex(namedMenuItems, function(namedMenuItem) {
    ...
    var cleanupMenu = function(namedMenuItems, removedMenuItems) {
      var menuItemsPass1 = $_anxm1mtajfuw8sct.filter(namedMenuItems, function(
        namedMenuItem
      ) {
        return removedMenuItems.hasOwnProperty(namedMenuItem.name) === false
      })
      var menuItemsPass2 = $_anxm1mtajfuw8sct.filter(menuItemsPass1, function(
        namedMenuItem,
        i,
        namedMenuItems
      ) {
      ...
      return $_anxm1mtajfuw8sct.filter(menuItemsPass2, function(
        namedMenuItem,
        i,
        namedMenuItems
      ) {
    ...
    var createMenu = function(
      ...
      if (menu) {
        ...
        menuButton.menu = $_anxm1mtajfuw8sct.map(
    ...
    var render = function(editor, theme, args) {
      ...
      panel = theme.panel = global$4.create({
        ...
        items: [
          ...
          $_g06972tdjfuw8sd2.hasSidebar(editor)
    ...
    var proto$1 = {
      ...
      initLayoutRect: function() {
        ...
        borderBox = self.borderBox =
          self.borderBox || $_xw61vtqjfuw8sep.measureBox(elm, 'border')
        self.paddingBox =
          self.paddingBox || $_xw61vtqjfuw8sep.measureBox(elm, 'padding')
        self.marginBox =
          self.marginBox || $_xw61vtqjfuw8sep.measureBox(elm, 'margin')
    ...
    var renderUI = function(editor, theme, args) {
      ...
      return isInline(editor)
        ? $_g6zuymtgjfuw8sd6.render(editor, theme, args)
        : $_6amrhfswjfuw8sbr.render(editor, theme, args)
    }
    ...
    var isComment = function(element) {
      return (
        type(element) === $_4uam9lv5jfuw8sjy.COMMENT ||
    ...
    var inBody = function(element) {
      var dom = $_a011ldv4jfuw8sjx.isText(element)
    ...
    function MixedBag(required, optional) {
      ...
      return function(obj) {
        ...
        $_anxm1mtajfuw8sct.each(optional, function(opt) {
          r[opt] = $_cun2p5t7jfuw8scg.constant(
    ...
    var detectBrowser = function(browsers, userAgent) {
      return detect$1(browsers, userAgent).map(function(browser) {
        var version = $_cb8wvsvljfuw8slm.detect(
    ...
    var removeLeading = function(str, prefix) {
      return startsWith(str, prefix)
        ? $_56mt3mvrjfuw8sm6.removeFromStart(str, prefix.length)
        : str
    }
    var removeTrailing = function(str, prefix) {
      return endsWith(str, prefix)
        ? $_56mt3mvrjfuw8sm6.removeFromEnd(str, prefix.length)
        : str
    }
    var ensureLeading = function(str, prefix) {
      return startsWith(str, prefix)
        ? str
        : $_56mt3mvrjfuw8sm6.addToStart(str, prefix)
    }
    var ensureTrailing = function(str, prefix) {
      return endsWith(str, prefix)
        ? str
        : $_56mt3mvrjfuw8sm6.addToEnd(str, prefix)
    }
    var contains$1 = function(str, substr) {
      return str.indexOf(substr) !== -1
    }
    var capitalize = function(str) {
      return $_7bobc1vsjfuw8sm7
        .head(str)
        .bind(function(head) {
    ...
    var browsers = [
      {
        ...
        search: function(uastring) {
          var monstrosity =
            $_8evc57vqjfuw8sm4.contains(uastring, 'edge/') &&
            $_8evc57vqjfuw8sm4.contains(uastring, 'chrome') &&
            $_8evc57vqjfuw8sm4.contains(uastring, 'safari') &&
            $_8evc57vqjfuw8sm4.contains(uastring, 'applewebkit')
          return monstrosity
        }
      },
      {
        ...
        search: function(uastring) {
          return (
            $_8evc57vqjfuw8sm4.contains(uastring, 'chrome') &&
            !$_8evc57vqjfuw8sm4.contains(uastring, 'chromeframe')
          )
        }
      },
      {
        ...
        search: function(uastring) {
          return (
            $_8evc57vqjfuw8sm4.contains(uastring, 'msie') ||
            $_8evc57vqjfuw8sm4.contains(uastring, 'trident')
          )
        }
      },
      {
      ...
      },
      {
        ...
        search: function(uastring) {
          return (
            ($_8evc57vqjfuw8sm4.contains(uastring, 'safari') ||
              $_8evc57vqjfuw8sm4.contains(uastring, 'mobile/')) &&
            $_8evc57vqjfuw8sm4.contains(uastring, 'applewebkit')
          )
        }
      }
    ...
    var oses = [
      ...
      },
      {
        ...
        search: function(uastring) {
          return (
            $_8evc57vqjfuw8sm4.contains(uastring, 'iphone') ||
            $_8evc57vqjfuw8sm4.contains(uastring, 'ipad')
          )
        },
        versionRegexes: [
          /.*?version\/\ ?([0-9]+)\.([0-9]+).*/,
    ...
    var detect$2 = function(userAgent) {
      ...
      var browser = $_1rd3rvvojfuw8slu
        .detectBrowser(browsers, userAgent)
        .fold($_5l1g9dvkjfuw8slj.unknown, $_5l1g9dvkjfuw8slj.nu)
      var os = $_1rd3rvvojfuw8slu
        .detectOs(oses, userAgent)
        .fold($_ej30zjvmjfuw8sln.unknown, $_ej30zjvmjfuw8sln.nu)
    ...
    var all = function(selector, scope) {
      ...
      return bypassSelector(base)
        ? []
        : $_anxm1mtajfuw8sct.map(
            base.querySelectorAll(selector),
            $_5ny1kxuzjfuw8sjh.fromDom
          )
    }
    ...
    var member = function(element, elements) {
      return $_anxm1mtajfuw8sct.exists(
        elements,
        $_cun2p5t7jfuw8scg.curry(eq, element)
      )
    }
    ...
    var parents = function(element, isRoot) {
      var stop = $_e8diihtbjfuw8scy.isFunction(isRoot)
        ? isRoot
        : $_cun2p5t7jfuw8scg.constant(false)
      var dom = element.dom()
      var ret = []
    ...
    var prevSiblings = function(element) {
      return $_anxm1mtajfuw8sct.reverse(
        $_ds6cwivcjfuw8sko.toArray(element, prevSibling)
      )
    }
    ...
    var ancestors = function(scope, predicate, isRoot) {
      return $_anxm1mtajfuw8sct.filter(
        $_3pu8ohv6jfuw8sk0.parents(scope, isRoot),
        predicate
      )
    }
    var siblings$1 = function(scope, predicate) {
      return $_anxm1mtajfuw8sct.filter(
        $_3pu8ohv6jfuw8sk0.siblings(scope),
        predicate
      )
    }
    var children$1 = function(scope, predicate) {
      return $_anxm1mtajfuw8sct.filter(
        $_3pu8ohv6jfuw8sk0.children(scope),
        predicate
      )
    }
    ...
    var ancestors$1 = function(scope, selector, isRoot) {
      return $_32ojrxv1jfuw8sjp.ancestors(
        scope,
        function(e) {
    ...
    var select = function(selector, root) {
      return $_anxm1mtajfuw8sct.map(
        $_d07cf8v0jfuw8sjn.descendants(
          $_5ny1kxuzjfuw8sjh.fromDom(root),
          selector
        ),
        function(element) {
          return element.dom()
    ...
    var anchorTarget = function(elm) {
      ...
      return create(
        ...
        '#' + anchorId,
        0,
        $_cun2p5t7jfuw8scg.noop
      )
    }
    var getHeaderTargets = function(elms) {
      return $_anxm1mtajfuw8sct.map(
        $_anxm1mtajfuw8sct.filter(elms, isValidHeader),
        headerTarget
      )
    }
    var getAnchorTargets = function(elms) {
      return $_anxm1mtajfuw8sct.map(
        $_anxm1mtajfuw8sct.filter(elms, isValidAnchor),
        anchorTarget
      )
    }
    ...
    var createMenuItems = function(term, targets, fileType, editorSettings) {
      ...
      var fromHistoryMenuItems = function(history) {
        var historyItems = history.hasOwnProperty(fileType)
          ? history[fileType]
          : []
        var uniqueHistory = $_anxm1mtajfuw8sct.filter(historyItems, function(
          url
        ) {
      ...
      var fromMenuItems = function(type) {
        var filteredTargets = $_anxm1mtajfuw8sct.filter(targets, function(
          target
        ) {
      ...
      var join = function(items) {
        return $_anxm1mtajfuw8sct.foldl(
          items,
          function(a, b) {
    ...
    function ClosestOrAncestor(is, ancestor, scope, a, isRoot) {
      return is(scope, a)
        ? Option.some(scope)
        : $_e8diihtbjfuw8scy.isFunction(isRoot) && isRoot(scope)
          ? Option.none()
    ...
    var sibling = function(scope, predicate) {
      ...
      return child$1($_5ny1kxuzjfuw8sjh.fromDom(element.parentNode), function(
        x
      ) {
    ...
    var child$1 = function(scope, predicate) {
      var result = $_anxm1mtajfuw8sct.find(
        scope.dom().childNodes,
        $_cun2p5t7jfuw8scg.compose(
          predicate,
          $_5ny1kxuzjfuw8sjh.fromDom
        )
      )
      ...
      var descend = function(element) {
        for (var i = 0; i < element.childNodes.length; i++) {
          if (predicate($_5ny1kxuzjfuw8sjh.fromDom(element.childNodes[i])))
            return Option.some(
              $_5ny1kxuzjfuw8sjh.fromDom(element.childNodes[i])
            )
    ...
    var ancestor$1 = function(scope, selector, isRoot) {
      return $_7wnjcvzjfuw8sn7.ancestor(
        scope,
        function(e) {
          return $_cy5apxvtjfuw8sm8.is(e, selector)
        },
    ...
    var createCustomMenuItems = function(editor, names) {
      ...
      if (typeof names === 'string') {
        ...
        return $_anxm1mtajfuw8sct.flatten(
    ...
    var trimMenuItems = function(menuItems) {
      var menuItems2 = $_anxm1mtajfuw8sct.filter(menuItems, function(
        menuItem,
        i,
        menuItems
      ) {
      ...
      return $_anxm1mtajfuw8sct.filter(menuItems2, function(
        menuItem,
        i,
        menuItems
      ) {
    ...
    var setupUiContainer = function(editor) {
      if (editor.settings.ui_container) {
        global$8.container = $_279ymavyjfuw8sn6
          .descendant(
            $_5ny1kxuzjfuw8sjh.fromDom(document.body),
            editor.settings.ui_container
          )
          .fold($_cun2p5t7jfuw8scg.constant(null), function(elm) {
            return elm.dom()
          })
      }
    }
    ...
    var Slider = Widget.extend({
      init: function(settings) {
        ...
        self._minValue = $_e8diihtbjfuw8scy.isNumber(settings.minValue)
          ? settings.minValue
          : 0
        self._maxValue = $_e8diihtbjfuw8scy.isNumber(settings.maxValue)
          ? settings.maxValue
          : 100
