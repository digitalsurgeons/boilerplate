      ...
      return (
        c &&
          ...
          (e = d
            ...
            : a("[name='" + c + "'][type=radio]", b.ownerDocument).filter(
                function() {
                  return !this.form
                }
              ))),
    ...
    a.widget('ui.button', {
      ...
      _create: function() {
        this.element
          ...
          .bind('reset' + this.eventNamespace, e),
            ...
            : 'radio' === this.type
              ...
              : (this.buttonElement
                  ...
                  .bind('mouseup' + this.eventNamespace, function() {
                    return (
                      !g.disabled && void a(this).removeClass('ui-state-active')
                    )
                  })
      ...
      _destroy: function() {
        this.element.removeClass('ui-helper-hidden-accessible'),
          this.buttonElement
            .removeClass(c + ' ui-state-active ' + d)
            .removeAttr('role')
      ...
      refresh: function() {
        var b = this.element.is('input, button')
      ...
      _resetButton: function() {
        ...
        e.primary || e.secondary
          ? (this.options.text &&
            ...
            this.options.text ||
              (g.push(f ? 'ui-button-icons-only' : 'ui-button-icon-only'),
              this.hasTitle || b.attr('title', a.trim(c))))
